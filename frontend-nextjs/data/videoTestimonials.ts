...
export const videoTestimonials: VideoTestimonial[] = [
  ...
  },
  {
    ...
    quote:
      'Mister DJ maakte van onze bruiloft een onvergetelijke ervaring. De perfecte mix van professionele uitvoering en persoonlijke aandacht.',
    rating: 5,
  },
  {
    id: 'testimonial-005',
...
export const filterTestimonials = (eventType?: VideoTestimonial['eventType']) =>
  eventType ? videoTestimonials.filter((t) => t.eventType === eventType) : videoTestimonials;
