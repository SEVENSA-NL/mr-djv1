...
export const PRICING_FAQ = [
  ...
  },
  {
    ...
    answer:
      'De vermelde prijzen zijn exclusief 21% BTW. Voor particuliere klanten geldt de prijs inclusief BTW. Voor zakelijke klanten wordt BTW separaat vermeld op de factuur.',
  },
];
