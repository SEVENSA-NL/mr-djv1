...
import { trackPhoneClick, trackEmailClick, trackWhatsAppClick } from "@/src/utils/tracking";
        ...
        <div className="grid gap-8 md:grid-cols-[minmax(0,1.1fr)_minmax(0,1fr)] md:items-start">
          <div>
            ...
            <h2 className="mb-3 text-2xl font-semibold text-gray-900 md:text-3xl lg:text-4xl">
              Vertel kort iets over jullie plannen &ndash; we denken graag mee.
            </h2>
            ...
            <p className="mb-4 text-sm text-yellow-600/90 font-medium">
            ...
            <div className="space-y-2 text-sm text-gray-600">
              ...
              <div>
                ...
                Kapteijnlaan 17, 5505 AV Veldhoven
              </div>
              <div>
              ...
              <div className="flex items-center gap-3 pt-2">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-gray-500 transition-colors hover:text-[#25D366]"
            ...
            <div className="rounded-2xl border border-gray-200 bg-gray-50 p-4 shadow-xl">
              {children ? (
                ...
                <div className="py-8 text-center text-xs text-gray-400">
                  Neem contact op via info@mr-dj.nl
                </div>
              )}
            </div>
          </div>
