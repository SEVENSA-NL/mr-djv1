    ...
    <main className="bg-white">
      <section className="mx-auto max-w-5xl px-4 py-12 lg:px-0">
        ...
        <div className="mb-16 grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
          <a
            href="/diensten/bruiloft-dj"
            className="group rounded-lg border border-slate-200 bg-white p-6 shadow-sm transition hover:shadow-md"
          >
            <div className="mb-3 text-4xl">💍</div>
            <h2 className="mb-2 text-xl font-semibold text-slate-900 group-hover:text-amber-600">
              Bruiloft DJ
            </h2>
            <p className="mb-4 text-sm text-slate-600">
              Maak je trouwdag onvergetelijk met de perfecte soundtrack. Van ceremonie tot late-night party.
            </p>
            <span className="text-sm font-medium text-amber-600 group-hover:underline">
              Meer over bruiloft DJ →
            </span>
          </a>

          <a
            href="/diensten/bedrijfsfeest-dj"
            className="group rounded-lg border border-slate-200 bg-white p-6 shadow-sm transition hover:shadow-md"
          >
            <div className="mb-3 text-4xl">🏢</div>
            <h2 className="mb-2 text-xl font-semibold text-slate-900 group-hover:text-amber-600">
            ...
            <p className="mb-4 text-sm text-slate-600">
              Professionele entertainment voor teamuitjes, jubilea en corporate events. Inclusief branding.
            </p>
            <span className="text-sm font-medium text-amber-600 group-hover:underline">
              Meer over bedrijfsfeest DJ →
            </span>
          </a>

          <a
            href="/diensten/feest-dj"
            className="group rounded-lg border border-slate-200 bg-white p-6 shadow-sm transition hover:shadow-md"
          >
            <div className="mb-3 text-4xl">🎉</div>
            <h2 className="mb-2 text-xl font-semibold text-slate-900 group-hover:text-amber-600">
            ...
            <p className="mb-4 text-sm text-slate-600">
              Verjaardagen, jubilea, themafeesten - wij zorgen voor de ultieme party vibe voor elke gelegenheid.
            </p>
            <span className="text-sm font-medium text-amber-600 group-hover:underline">
              Meer over feest DJ →
            </span>
          ...
          <div className="rounded-lg border border-slate-200 bg-slate-50 p-6">
            <div className="mb-3 text-4xl">🎷</div>
            <h2 className="mb-2 text-xl font-semibold text-slate-900">Live Saxofoon</h2>
            <p className="text-sm text-slate-600">
              Upgrade elk event met een live saxofonist die meespeelt met de DJ. Het verschil tussen leuk en legendarisch.
            </p>
          </div>

          <div className="rounded-lg border border-slate-200 bg-slate-50 p-6">
            <div className="mb-3 text-4xl">🎤</div>
            <h2 className="mb-2 text-xl font-semibold text-slate-900">Ceremonie Begeleiding</h2>
            <p className="text-sm text-slate-600">
              Professionele audio voor speeches, presentaties en ceremonies. Draadloze microfoons en geluidsversterking.
            </p>
          </div>

          <div className="rounded-lg border border-slate-200 bg-slate-50 p-6">
            <div className="mb-3 text-4xl">💡</div>
            <h2 className="mb-2 text-xl font-semibold text-slate-900">Licht & Visuals</h2>
            <p className="text-sm text-slate-600">
              Spectaculaire lichtshows, moving heads, LED spots en optionele projectie/visuals voor extra impact.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="space-y-4">
            <details className="rounded-lg border border-slate-200 p-5">
              ...
              <p className="mt-3 text-sm text-slate-600">
                Onze pakketten starten vanaf €495 voor 4 uur (pakket Brons), tot €1295 voor een complete 8-uur show met live saxofonist (pakket Goud). Bekijk de volledige prijslijst op onze <a href="/pakketten" className="text-amber-600 underline">pakketten pagina</a>.
              </p>
            </details>
            <details className="rounded-lg border border-slate-200 p-5">
              <summary className="cursor-pointer font-medium text-slate-900">
              ...
              <p className="mt-3 text-sm text-slate-600">
                Ja, absoluut! Alle pakketten inclusief professionele draadloze microfoons voor speeches, ceremonies en presentaties. We zorgen voor heldere audio zodat iedereen alles kan verstaan.
              </p>
            </details>
            <details className="rounded-lg border border-slate-200 p-5">
              <summary className="cursor-pointer font-medium text-slate-900">
              ...
              <p className="mt-3 text-sm text-slate-600">
                Voor bruiloften adviseren we 6-12 maanden van tevoren (vooral voor populaire datums in het weekend). Voor bedrijfsfeesten en private events kan het soms ook met kortere doorlooptijd. Check altijd even onze beschikbaarheid!
              </p>
            </details>
            <details className="rounded-lg border border-slate-200 p-5">
              <summary className="cursor-pointer font-medium text-slate-900">
